...
const stripePromise = loadStripe('pk_test_51LlFNaHRUYUwhL1YKPjUVJowTiOgxyGZEuQ2ERmby5WcgRLLjEguHBsQKCnRbQsJh0WlcsPR1tvtuBQFS6xd6TTq00Jt6m2cxJ')
                ...
                <tbody>
                    ...
                    {cart.map((item) => (
                      <tr>
                        ...
                        <td>{parseInt(item.price).toLocaleString("Id",{ style: 'currency', currency: 'IDR' })}</td>
                        <td>
                        ...
                        <td>{(item.price * user.cart[item._id]).toLocaleString("Id",{ style: 'currency', currency: 'IDR' })}</td>
                      </tr>
                    ))}
                </tbody>
            </Table>
            <div>
                <h3 className="h4 pt-4">Total: {parseInt(user.cart.total).toLocaleString("Id",{ style: 'currency', currency: 'IDR' })}</h3>
            </div>
        </>
        )}
        </Col>
