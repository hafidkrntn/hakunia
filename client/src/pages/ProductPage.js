...
import { Container, Row, Col, Badge, Button, ButtonGroup, Form } from 'react-bootstrap'
    ...
    <Container className="pt-4" style={{position: 'relative'}}>
        <Row>
            ...
            <Col lg={6} className="pt-4">
                ...
                <p className="product__price">{parseInt(product.price).toLocaleString("Id",{ style: 'currency', currency: 'IDR' })}</p>
