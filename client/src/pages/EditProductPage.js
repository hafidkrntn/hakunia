...
const EditProductPage = () => {
    ...
    function showWidget() {
        const widget = window.cloudinary.createUploadWidget(
            {
                cloudName: "hafidkrntn",
                uploadPreset: "hakunia",
            },
            (error, result) => {
            ...
            <Row>
                <Col md={6} className="new-product__form--container">
                    <Form style={{ width: "100%" }} onSubmit={handleSubmit}>
                        ...
                        {isSuccess && <Alert variant="success">Product edited</Alert>}
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="number" placeholder="Price (Rp)" value={price} required onChange={(e) => setPrice(e.target.value)} />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3" onChange={(e) => setCategory(e.target.value)}>
                            ...
                            <Form.Select value={category}>
                                ...
                                <option value="girls">Fashion Girls</option>
                                <option value="laptops">Fashion Boys</option>
                                <option value="laptops">Fashion Kids</option>
                            </Form.Select>
                        </Form.Group>
